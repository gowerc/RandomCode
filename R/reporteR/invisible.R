...
#
#
# Exploring what define(visible=FALSE) does
#     By default all columns in the table are included into the
#     output. Setting visible = false means the column is excluded
#     from the table. Note that the `define()` statements are
#     just used to apply formatting or other metadata configuration
#
#
